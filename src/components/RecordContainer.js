...
<div>
<svg class="svg-icon" viewBox="0 0 20 20" style={{width: "40px",height: "30px" ,float:"right"  ,marginRight:"10px"}}>
            ...
            <Link to ='/admin'  style ={{textDecoration:"none"}}exact ><span>
         
         
         <div>
         <svg class="svg-icon" viewBox="0 0 20 20" style={{width: "40px",height: "30px" ,float:"right"  ,marginRight:"20px"}}>
