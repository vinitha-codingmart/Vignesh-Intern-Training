...
class Admincontainer extends Component {
    ...
    render() { 
        return (
           <div>
               <div className = "nav" style={{backgroundColor:"#1278F9",height:"55px",color:"white",margin : "20px",borderRadius:"20px"}}>
...
<div>
<svg class="svg-icon" viewBox="0 0 20 20" style={{width: "40px",height: "30px" ,float:"right" ,marginTop:"20px" ,marginRight:"10px"}}>
            ...
            <Link to ='/record'  style ={{textDecoration:"none"}}exact ><span>
         
         
         <div>
            <svg class="svg-icon" viewBox="0 0 20 20" style={{width: "20px",float:"right", marginTop:"20px",
  height: "2em",marginRight:"30px"}}>
